...
# import openai
from openai import OpenAI  # 导入新的客户端
...
def chatgpt_generator(model,message, temp=0.0, max_len=1024):
    ...
    #     openai.api_key = "bce-v3/ALTAK-oMoqiXdMhfHOQSlZdkIMK/9e1eba64c3a3870a68043550df1736dd94133489"
    #     openai.api_base = "https://qianfan.baidubce.com/v2"
