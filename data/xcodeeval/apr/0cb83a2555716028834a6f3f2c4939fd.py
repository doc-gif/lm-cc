...
if 'bad' in status.values():
	...
	if status['top'] == status['bottom'] == 'ok' and status['front'] == status['left'] == status['right'] == status['back'] == 'h':
		...
		if (faces['front'][0] == faces['top'][3] and
			...
			print('NO')
	elif status['front'] == status['back'] == 'ok' and status['top'] == status['left'] == status['right'] == status['bottom'] == 'v':
		if (faces['top'][0] == faces['left'][3] and
			faces['left'][0] == faces['bottom'][3] and
			faces['bottom'][0] == faces['right'][3] and
			faces['right'][0] == faces['top'][3] 
			or
			faces['top'][0] == faces['right'][3] and
			faces['right'][0] == faces['bottom'][3] and
			faces['bottom'][0] == faces['left'][3] and
